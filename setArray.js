...
console.log(
  document.querySelector(
    "body > div.main > div > section > div.contentHolder > div"
  ).innerText
);
...
let script = function () {
  let shifts = document.querySelector(
    "div[data-bind='visible: !isLoading() && !hasData()']"
  );
  if (
    shifts.innerText !== "There is no information to display for this period"
  ) {
    var snd = new Audio(
...
localStorage.setItem("shifts", script.toString());
